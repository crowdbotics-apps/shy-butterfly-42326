"""
Django settings for shy_butterfly_42326 project.
...
ROOT_URLCONF = 'shy_butterfly_42326.urls'
...
WSGI_APPLICATION = 'shy_butterfly_42326.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shy_butterfly_42326 API",
    "DESCRIPTION": "API documentation for shy_butterfly_42326 App",
    "VERSION": "v1",
}
